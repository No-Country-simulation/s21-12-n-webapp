...
@Tag(name = "Recuperación de Contraseña", description = "Endpoints para la gestión de la recuperación de contraseña")
@RestController
...
public class PasswordRecoveryController {
    ...
    @Operation(summary = "Crear token de recuperación", description = "Genera un token para recuperar la contraseña del usuario",
            responses = {
    ...
    @Operation(summary = "Verificar token", description = "Verifica la validez del token de recuperación",
            responses = {
